        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-6 mx-auto">
                    <div class="card">
                        <div class="card-header">Consumindo API de CEP</div>
                        <div class="card-body">
                            ...
                            <form action="" class="px-5">
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" name="cep" id="cep"
                                        class="form-control cep required" placeholder="00000-00">
                                </div>
                                <div class="form-group my-2">
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <select name="estado" id="estado" class="form-control">
                                        ...
                                        <option name="DF" id="estado-df" value="DF">Distrito Federal
                                        </option>
                                        <option name="ES" id="estado-es" value="ES">Espírito Santo
                                        </option>
                                        <option name="GO" id="estado-go" value="GO">Goiás</option>
                                        <option name="MA" id="estado-ma" value="MA">Maranhão
                                        </option>
                                        <option name="MT" id="estado-mt" value="MT">Mato Grosso
                                        </option>
                                        <option name="MS" id="estado-ms" value="MS">Mato Grosso do
                                            Sul
                                        </option>
                                        <option name="MG" id="estado-mg" value="MG">Minas Gerais
                                        </option>
                                        ...
                                        <option name="PE" id="estado-pe" value="PE">Pernambuco
                                        </option>
                                        <option name="PI" id="estado-pi" value="PI">Piauí</option>
                                        <option name="RJ" id="estado-rj" value="RJ">Rio de Janeiro
                                        </option>
                                        <option name="RN" id="estado-rn" value="RN">Rio Grande do
                                            Norte
                                        </option>
                                        <option name="RS" id="estado-rs" value="RS">Rio Grande do
                                            Sul
                                        </option>
                                        <option name="RO" id="estado-ro" value="RO">Rondônia
                                        </option>
                                        <option name="RR" id="estado-rr" value="RR">Roraima</option>
                                        <option name="SC" id="estado-sc" value="SC">Santa Catarina
                                        </option>
                                        <option name="SP" id="estado-sp" value="SP">São Paulo
                                        </option>
                                        <option name="SE" id="estado-se" value="SE">Sergipe</option>
                                        <option name="TO" id="estado-to" value="TO">Tocantins
                                        </option>
